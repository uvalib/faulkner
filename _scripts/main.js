      ...
      rev1 = new RevealFx(document.querySelector('#rev-1'), {
        revealSettings : {
          ...
          onCover: function(contentEl, revealerEl) {
            ...
            //splitContent.classList.add('header__right-section--show');
						var r = document.querySelector(".header__right-section");
						var l = document.querySelector(".header__left-section");
						r.className += " header__right-section--show";
						l.className += " header__left-section--show";
          }
        }
      });
